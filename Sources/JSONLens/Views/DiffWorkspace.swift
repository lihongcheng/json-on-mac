        ...
        VSplitView {
            HSplitView {
                JSONEditorPane(
                    ...
                    previewText: model.parsed?.presentationFormatted,
                    previewRoot: model.parsed?.rootNode,
                    previewIndentSize: model.indentSize,
                    viewMode: $model.sourceEditorView,
                ...
                JSONEditorPane(
                    ...
                    previewText: model.comparisonParsed?.presentationFormatted,
                    previewRoot: model.comparisonParsed?.rootNode,
                    previewIndentSize: model.indentSize,
                    viewMode: $model.comparisonEditorView,
